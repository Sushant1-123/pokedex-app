        ...
        slivers: [
          SliverPadding(
            padding: EdgeInsets.fromLTRB(
                isDesktop ? 32 : 18, 24, isDesktop ? 32 : 18, 0),
            sliver: SliverToBoxAdapter(
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                  const Text('SPECIMEN INDEX',
                      style: TextStyle(
                  ...
                  const Text('RESEARCH-GRADE FIELD POKÉDEX',
                      style: TextStyle(
