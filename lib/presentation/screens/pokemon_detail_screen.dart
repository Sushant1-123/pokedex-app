      ...
      body: SafeArea(
        ...
        Container(
            ...
            child: Row(children: [
              ...
              const Text('SPECIMEN TELEMETRY',
                  style: TextStyle(
                      color: AppTheme.paper,
                      fontWeight: FontWeight.w700,
                      letterSpacing: 1.5)),
              const Spacer(),
              Text('RECORD / ${nameOrId.toUpperCase()}',
                  style: const TextStyle(color: AppTheme.signal, fontSize: 10)),
            ])),
        Expanded(
            child: switch (result) {
          ...
          Success(data: final detail) =>
            LayoutBuilder(builder: (context, constraints) {
              ...
              final accent = detail.types.isNotEmpty
                  ...
                  : AppTheme.signal;
              final identity =
                  _Identity(detail: detail, heroTag: heroTag, accent: accent);
...
class _Identity extends StatelessWidget {
  ...
  final Color accent;
  const _Identity(
      {required this.detail, required this.heroTag, required this.accent});
  @override
  Widget build(BuildContext context) =>
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Expanded(
            child: Text(_titleCase(detail.name),
        ...
        Wrap(
          ...
          children: detail.abilities
              .map((ability) => Container(
                    ...
                    child: Text(_titleCase(ability.replaceAll('-', ' ')),
                        style: const TextStyle(
                            color: AppTheme.paper, fontSize: 11)),
                  ))
              .toList(),
        ),
      ]);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(label,
                style: const TextStyle(
                    fontSize: 10, color: AppTheme.muted, letterSpacing: 1)),
          ],
        ),
      ),
    );
